...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        [Fact]
        public void GetCommandItems_ReturnOneItem_WhenDBHasOneResource()
        {
            //Given
        ...
        [Fact]
        public void GetCommandItems_ReturnCurrectType_WhenDBHasOneResource()
        {
            //Given
            mockRepo.Setup(repo => repo.GetAllCommands()).Returns(GetCommand(1));
        ...
        [Fact]
        public void GetCommandByID_ReturnsCurrectType__WhenValidIDProvided()
        {
            //Arrange
            mockRepo.Setup(repo =>
            repo.GetCommandById(1)).Returns(new Command
